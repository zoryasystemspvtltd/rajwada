...
const IUIOutsideActivityCreate = (props) => {
    ...
    const initialParams = { projectId: null, towerId: null, floorId: null, outSideEntityId: null, type: "Outside", workflowId: null, dependencyId: null, photoUrl: null };
    // Parameter
    const { id } = useParams();
    ...
    const filteredDependencies = allDependencies.filter(item => {
        ...
        const matchesD = dependencySelectParams?.outSideEntityId !== null ? item.outSideEntityId === parseInt(dependencySelectParams.outSideEntityId) : true;
    ...
    const prepareActivityCreation = async (e) => {
        ...
        setDependencySelectParams({
            ...
            outSideEntityId: selectedDependency?.outSideEntityId,
            type: "Outside",
            photoUrl: item?.data?.blueprint
        });
        let activityParentId = -1;
        if (selectedDependency?.outSideEntityId !== null) {
            activityParentId = selectedDependency?.outSideEntityId;
        }
...
export default IUIOutsideActivityCreate;
