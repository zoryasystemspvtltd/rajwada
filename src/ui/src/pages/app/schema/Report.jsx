...
// import IUIPageReport from "../../common/IUIPageReport";
import IUIReportGrid from "../../common/IUIReportGrid";
...
export const ListReport = () => {
    ...
    const schema2 = {
        ...
        adding: true,
        fields: [
            { text: 'Name', field: 'name', type: 'link', sorting: true, width: 2},
            { text: 'Start Date', field: 'startDate', width: 1, type: 'label-date' },
            { text: 'End Date', field: 'endDate', width: 1, type: 'label-date'},
            { text: 'Actual Start Date', field: 'actualStartDate', width: 1, type: 'label-date' },
            { text: 'Actual End Date', field: 'actualEndDate', width: 1, type: 'label-date'},
            { text: 'Reporting Details', field: 'endDate', width: 7, type: 'buttons' },
    ...
    return (
    <>
        {/* <IUIList schema={schema} /> */}
        <IUIReportGrid schema={schema2} 
...
//     return (<IUIPageReport schema={schema} />)
// }
