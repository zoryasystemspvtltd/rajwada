...
const ProjectWiseInProgressReport = () => {
    ...
    const handleSearch = async () => {
        try {
            ...
            const response = await api.projectWiseInProgressReport({ data: payload });
    ...
    const handleExportToExcel = () => {
        ...
        XLSX.utils.book_append_sheet(workbook, worksheet, 'ProjectWiseInProgress Report');
        const excelBuffer = XLSX.write(workbook, { bookType: 'xlsx', type: 'array' });
        const blob = new Blob([excelBuffer], { type: 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet' });
        saveAs(blob, `ProjectWiseInProgressReport-${new Date().toISOString().split('T')[0]}.xlsx`);
    };
...
export default ProjectWiseInProgressReport;
