...
const ProjectWiseClosedReport = () => {
    ...
    const handleSearch = async () => {
        try {
            ...
            const response = await api.projectWiseClosedReport({ data: payload });
    ...
    const handleExportToExcel = () => {
        ...
        XLSX.utils.book_append_sheet(workbook, worksheet, 'ProjectWiseClosed Report');
        const excelBuffer = XLSX.write(workbook, { bookType: 'xlsx', type: 'array' });
        const blob = new Blob([excelBuffer], { type: 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet' });
        saveAs(blob, `ProjectWiseClosedReport-${new Date().toISOString().split('T')[0]}.xlsx`);
    };
    ...
    return (
        <>
            <div className="app-page-title">
                <div className="page-title-heading text-uppercase">Project Wise Closed Report</div>
            </div>
...
export default ProjectWiseClosedReport;
