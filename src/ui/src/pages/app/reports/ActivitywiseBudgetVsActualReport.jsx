...
const ActivitywiseBudgetVsActualReport = () => {
    ...
    const handleExportToExcel = () => {
        ...
        XLSX.utils.book_append_sheet(workbook, worksheet, 'ActivitywiseBudgetVsActual Report');
        const excelBuffer = XLSX.write(workbook, { bookType: 'xlsx', type: 'array' });
        const blob = new Blob([excelBuffer], { type: 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet' });
        saveAs(blob, `ActivitywiseBudgetVsActualReport-${new Date().toISOString().split('T')[0]}.xlsx`);
    };
    ...
    return (
        <>
            <div className="app-page-title">
                <div className="page-title-heading text-uppercase">Activity Wise Budget Vs Actual Report</div>
            </div>
...
export default ActivitywiseBudgetVsActualReport;
