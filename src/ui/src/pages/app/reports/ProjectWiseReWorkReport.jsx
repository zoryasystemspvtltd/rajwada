...
const ProjectWiseReWorkReport = () => {
    ...
    const handleSearch = async () => {
        try {
            ...
            const response = await api.projectWiseReWorkReport({ data: payload });
    ...
    const handleExportToExcel = () => {
        ...
        XLSX.utils.book_append_sheet(workbook, worksheet, 'ProjectWiseReWork Report');
        const excelBuffer = XLSX.write(workbook, { bookType: 'xlsx', type: 'array' });
        const blob = new Blob([excelBuffer], { type: 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet' });
        saveAs(blob, `ProjectWiseReWorkReport-${new Date().toISOString().split('T')[0]}.xlsx`);
    };
    ...
    return (
        <>
            <div className="app-page-title">
                <div className="page-title-heading text-uppercase">Project Wise ReWork Report</div>
            </div>
...
export default ProjectWiseReWorkReport;
