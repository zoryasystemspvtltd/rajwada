...
namespace RajApi.Migrations
{
    ...
    [Migration("20241230103225_identity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RajApi.Data.Models.ApplicationLog", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            ActivityType = 0,
                            Date = new DateTime(2024, 12, 30, 10, 32, 23, 251, DateTimeKind.Utc).AddTicks(3400),
                            EntityId = 1L,
                        ...
                        new
                        {
                            Id = 2L,
                            ActivityType = 0,
                            Date = new DateTime(2024, 12, 30, 10, 32, 23, 251, DateTimeKind.Utc).AddTicks(3403),
                            EntityId = 1L,
                            Key = "1536B022-C5C9-4358-BB6A-466F2075B7D4",
                            Member = "super@rajwada.com",
                            Name = "Department",
                        ...
                        new
                        {
                            Id = 3L,
                            ActivityType = 0,
                            Date = new DateTime(2024, 12, 30, 10, 32, 23, 251, DateTimeKind.Utc).AddTicks(3406),
                            EntityId = 2L,
                            Key = "1536B022-C5C9-4358-BB6A-466F2075B7D4",
                            Member = "super@rajwada.com",
                            Name = "Department",
            ...
            modelBuilder.Entity("RajApi.Data.Models.AssetType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            Code = "FA",
                            Date = new DateTime(2024, 12, 30, 10, 32, 23, 251, DateTimeKind.Utc).AddTicks(3510),
                            Key = "1536B022-C5C9-4358-BB6A-466F2075B7D4",
                            Member = "super@rajwada.com",
                            Name = "Fixed Asset",
                            Status = 0
                        ...
                        new
                        {
                            Id = 2L,
                            Code = "CB",
                            Date = new DateTime(2024, 12, 30, 10, 32, 23, 251, DateTimeKind.Utc).AddTicks(3512),
                            Key = "1536B022-C5C9-4358-BB6A-466F2075B7D4",
                            Member = "super@rajwada.com",
                        ...
                        new
                        {
                            Id = 3L,
                            Code = "SA",
                            Date = new DateTime(2024, 12, 30, 10, 32, 23, 251, DateTimeKind.Utc).AddTicks(3515),
                            Key = "1536B022-C5C9-4358-BB6A-466F2075B7D4",
                            Member = "super@rajwada.com",
                            Name = "Service Assets",
                            Status = 0
            ...
            modelBuilder.Entity("RajApi.Data.Models.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            Code = "RE",
                            Date = new DateTime(2024, 12, 30, 10, 32, 23, 251, DateTimeKind.Utc).AddTicks(3048),
                            Key = "1536B022-C5C9-4358-BB6A-466F2075B7D4",
                            Member = "super@rajwada.com",
                            Name = "Rajwara",
                            Status = 0,
            ...
            modelBuilder.Entity("RajApi.Data.Models.Department", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            Code = "CI",
                            Date = new DateTime(2024, 12, 30, 10, 32, 23, 251, DateTimeKind.Utc).AddTicks(3360),
                            Key = "1536B022-C5C9-4358-BB6A-466F2075B7D4",
                            Member = "super@rajwada.com",
                            Name = "Civil",
                            Status = 0
                        ...
                        new
                        {
                            Id = 2L,
                            Code = "LE",
                            Date = new DateTime(2024, 12, 30, 10, 32, 23, 251, DateTimeKind.Utc).AddTicks(3363),
                            Key = "1536B022-C5C9-4358-BB6A-466F2075B7D4",
                            Member = "super@rajwada.com",
                            Name = "Legal",
                            Status = 0
            ...
            modelBuilder.Entity("RajApi.Data.Models.LevelSetupDetails", b =>
                {
                    ...
                    b.Property<long?>("LevelSetupMasterId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("LevelSetupMasterId");

                    b.ToTable("LevelSetupDetails");
                });

            modelBuilder.Entity("RajApi.Data.Models.LevelSetupMaster", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("RajApi.Data.Models.LevelSetupDetails", b =>
                {
                    b.HasOne("RajApi.Data.Models.LevelSetupMaster", "LevelSetupMaster")
                        .WithMany()
                        .HasForeignKey("LevelSetupMasterId");

                    b.Navigation("LevelSetupMaster");
                });
