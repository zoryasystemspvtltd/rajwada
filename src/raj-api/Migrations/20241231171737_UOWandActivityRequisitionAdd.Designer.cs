...
namespace RajApi.Migrations
{
    ...
    [Migration("20241231171737_UOWandActivityRequisitionAdd")]
    partial class UOWandActivityRequisitionAdd
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RajApi.Data.Models.ApplicationLog", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            ActivityType = 0,
                            Date = new DateTime(2024, 12, 31, 17, 17, 35, 392, DateTimeKind.Utc).AddTicks(1559),
                            EntityId = 1L,
                        ...
                        new
                        {
                            Id = 2L,
                            ActivityType = 0,
                            Date = new DateTime(2024, 12, 31, 17, 17, 35, 392, DateTimeKind.Utc).AddTicks(1563),
                            EntityId = 1L,
                            Key = "1536B022-C5C9-4358-BB6A-466F2075B7D4",
                            Member = "super@rajwada.com",
                            Name = "Department",
                        ...
                        new
                        {
                            Id = 3L,
                            ActivityType = 0,
                            Date = new DateTime(2024, 12, 31, 17, 17, 35, 392, DateTimeKind.Utc).AddTicks(1619),
                            EntityId = 2L,
                            Key = "1536B022-C5C9-4358-BB6A-466F2075B7D4",
                            Member = "super@rajwada.com",
                            Name = "Department",
            ...
            modelBuilder.Entity("RajApi.Data.Models.AssetType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            Code = "FA",
                            Date = new DateTime(2024, 12, 31, 17, 17, 35, 392, DateTimeKind.Utc).AddTicks(1647),
                            Key = "1536B022-C5C9-4358-BB6A-466F2075B7D4",
                            Member = "super@rajwada.com",
                            Name = "Fixed Asset",
                            Status = 0
                        ...
                        new
                        {
                            Id = 2L,
                            Code = "CB",
                            Date = new DateTime(2024, 12, 31, 17, 17, 35, 392, DateTimeKind.Utc).AddTicks(1648),
                            Key = "1536B022-C5C9-4358-BB6A-466F2075B7D4",
                            Member = "super@rajwada.com",
                        ...
                        new
                        {
                            Id = 3L,
                            Code = "SA",
                            Date = new DateTime(2024, 12, 31, 17, 17, 35, 392, DateTimeKind.Utc).AddTicks(1650),
                            Key = "1536B022-C5C9-4358-BB6A-466F2075B7D4",
                            Member = "super@rajwada.com",
                            Name = "Service Assets",
                            Status = 0
            ...
            modelBuilder.Entity("RajApi.Data.Models.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            Code = "RE",
                            Date = new DateTime(2024, 12, 31, 17, 17, 35, 392, DateTimeKind.Utc).AddTicks(1385),
                            Key = "1536B022-C5C9-4358-BB6A-466F2075B7D4",
                            Member = "super@rajwada.com",
                            Name = "Rajwara",
                            Status = 0,
            ...
            modelBuilder.Entity("RajApi.Data.Models.Department", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            Code = "CI",
                            Date = new DateTime(2024, 12, 31, 17, 17, 35, 392, DateTimeKind.Utc).AddTicks(1530),
                            Key = "1536B022-C5C9-4358-BB6A-466F2075B7D4",
                            Member = "super@rajwada.com",
                            Name = "Civil",
                            Status = 0
                        ...
                        new
                        {
                            Id = 2L,
                            Code = "LE",
                            Date = new DateTime(2024, 12, 31, 17, 17, 35, 392, DateTimeKind.Utc).AddTicks(1532),
                            Key = "1536B022-C5C9-4358-BB6A-466F2075B7D4",
                            Member = "super@rajwada.com",
                            Name = "Legal",
                            Status = 0
