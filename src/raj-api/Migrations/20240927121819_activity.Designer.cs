...
namespace RajApi.Migrations
{
    ...
    [Migration("20240927121819_activity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RajApi.Data.Models.ActivityDependency", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<long?>("FromActivityId")
                        .HasColumnType("bigint");
                    ...
                    b.Property<long?>("ToActivityId")
                        .HasColumnType("bigint");

                    b.HasKey("Id");

                    b.HasIndex("FromActivityId");
            ...
            modelBuilder.Entity("RajApi.Data.Models.ApplicationLog", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            ActivityType = 0,
                            Date = new DateTime(2024, 9, 27, 12, 18, 13, 437, DateTimeKind.Utc).AddTicks(4238),
                            EntityId = 1L,
                        ...
                        new
                        {
                            Id = 2L,
                            ActivityType = 0,
                            Date = new DateTime(2024, 9, 27, 12, 18, 13, 437, DateTimeKind.Utc).AddTicks(4244),
                            EntityId = 1L,
                            Key = "1536B022-C5C9-4358-BB6A-466F2075B7D4",
                            Member = "super@rajwada.com",
                            Name = "Department",
                        ...
                        new
                        {
                            Id = 3L,
                            ActivityType = 0,
                            Date = new DateTime(2024, 9, 27, 12, 18, 13, 437, DateTimeKind.Utc).AddTicks(4249),
                            EntityId = 2L,
                            Key = "1536B022-C5C9-4358-BB6A-466F2075B7D4",
                            Member = "super@rajwada.com",
                            Name = "Department",
            ...
            modelBuilder.Entity("RajApi.Data.Models.AssetType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            Code = "FA",
                            Date = new DateTime(2024, 9, 27, 12, 18, 13, 437, DateTimeKind.Utc).AddTicks(4377),
                            Key = "1536B022-C5C9-4358-BB6A-466F2075B7D4",
                            Member = "super@rajwada.com",
                            Name = "Fixed Asset",
                            Status = 0
                        ...
                        new
                        {
                            Id = 2L,
                            Code = "CB",
                            Date = new DateTime(2024, 9, 27, 12, 18, 13, 437, DateTimeKind.Utc).AddTicks(4382),
                            Key = "1536B022-C5C9-4358-BB6A-466F2075B7D4",
                            Member = "super@rajwada.com",
                        ...
                        new
                        {
                            Id = 3L,
                            Code = "SA",
                            Date = new DateTime(2024, 9, 27, 12, 18, 13, 437, DateTimeKind.Utc).AddTicks(4386),
                            Key = "1536B022-C5C9-4358-BB6A-466F2075B7D4",
                            Member = "super@rajwada.com",
                            Name = "Service Assets",
                            Status = 0
            ...
            modelBuilder.Entity("RajApi.Data.Models.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            Code = "RE",
                            Date = new DateTime(2024, 9, 27, 12, 18, 13, 437, DateTimeKind.Utc).AddTicks(3778),
                            Key = "1536B022-C5C9-4358-BB6A-466F2075B7D4",
                            Member = "super@rajwada.com",
                            Name = "Rajwara",
                            Status = 0,
            ...
            modelBuilder.Entity("RajApi.Data.Models.Department", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            Code = "CI",
                            Date = new DateTime(2024, 9, 27, 12, 18, 13, 437, DateTimeKind.Utc).AddTicks(4157),
                            Key = "1536B022-C5C9-4358-BB6A-466F2075B7D4",
                            Member = "super@rajwada.com",
                            Name = "Civil",
                            Status = 0
                        ...
                        new
                        {
                            Id = 2L,
                            Code = "LE",
                            Date = new DateTime(2024, 9, 27, 12, 18, 13, 437, DateTimeKind.Utc).AddTicks(4163),
                            Key = "1536B022-C5C9-4358-BB6A-466F2075B7D4",
                            Member = "super@rajwada.com",
                            Name = "Legal",
                            Status = 0
            ...
            modelBuilder.Entity("RajApi.Data.Models.ActivityDependency", b =>
                {
                    b.HasOne("RajApi.Data.Models.Activity", "FromActivity")
                        .WithMany()
                        .HasForeignKey("FromActivityId");

                    b.HasOne("RajApi.Data.Models.Activity", "ToActivity")
                        .WithMany()
                        .HasForeignKey("ToActivityId");

                    b.Navigation("FromActivity");
